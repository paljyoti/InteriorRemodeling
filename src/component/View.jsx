...
function View() {
  return (
    <div className="bg-black p-4 sm:p-8 lg:p-12">
      ...
      <div className="text-center sm:text-left text-white flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-4 sm:gap-8">
        <p className="text-base sm:text-lg leading-relaxed w-full sm:w-1/2 pl-20">
      ...
      <div className="relative w-full h-60 sm:h-80 lg:h-[500px] mt-8">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-4 bg-black bg-opacity-50">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2 text-white sm:mb-4 ml-2 sm:ml-6 lg:ml-12">
            Embassy Row Renovation
          </h1>
          <p className="text-sm sm:text-base lg:text-lg ml-2 sm:ml-6 lg:ml-12 mb-4 text-white">
